	...
	if (!opendtls_vars.state_busy ){
		...
		switch( opendtls_vars.ssl.state ){
			case MBEDTLS_SSL_HELLO_REQUEST:		  //0
				...
				//this state should be done in OPENDTLS_HELLO_REQUEST_TIMER time
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_REQUESTING_CLIENT_HELLO, opendtls_vars.ssl.state, OPENDTLS_HELLO_REQUEST_TIMER );
			...
			case MBEDTLS_SSL_CLIENT_HELLO:			//1 
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_SENDING_CLIENT_HELLO, opendtls_vars.ssl.state, OPENDTLS_CLIENT_HELLO_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_SERVER_HELLO:			//2
				...
				opentimers_scheduleAbsolute(
					opendtls_vars.timerId,
					OPENDTLS_SERVER_HELLO_TIMER,
					sctimer_readCounter(),
					TIME_MS,
					opendtls_handshake_cb
				);

				openserial_printInfo( COMPONENT_OPENDTLS, ERR_PARSING_SERVER_HELLO, opendtls_vars.ssl.state, OPENDTLS_SERVER_HELLO_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_SERVER_CERTIFICATE:		//3
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_PARSING_SERVER_CERT, opendtls_vars.ssl.state, OPENDTLS_SERVER_CERTIFICATE_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_SERVER_KEY_EXCHANGE:	  //4
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_PARSING_SERVER_KEX, opendtls_vars.ssl.state, OPENDTLS_SERVER_KEX_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_CERTIFICATE_REQUEST:	  //5
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_CERTIFICATE_REQUEST, opendtls_vars.ssl.state, OPENDTLS_CERTIFICATE_REQ_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_SERVER_HELLO_DONE:		 //6
				...
				opentimers_scheduleAbsolute(
					opendtls_vars.timerId,
					OPENDTLS_SERVER_HELLO_DONE,
					sctimer_readCounter(),
					TIME_MS,
					opendtls_handshake_cb
				);

				openserial_printInfo( COMPONENT_OPENDTLS, ERR_PARSING_SERVER_HELLO_DONE, opendtls_vars.ssl.state, OPENDTLS_SERVER_HELLO_DONE );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_CLIENT_CERTIFICATE:		//7
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_PREP_CLIENT_CERT, opendtls_vars.ssl.state, OPENDTLS_CLIENT_CERT_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_CLIENT_KEY_EXCHANGE:	  //8
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_SENDING_CLIENT_KEX, opendtls_vars.ssl.state, OPENDTLS_CLIENT_KEX_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_CERTIFICATE_VERIFY:	  //9
				...
				opentimers_scheduleAbsolute(
					opendtls_vars.timerId,
					OPENDTLS_CERT_VERIFY_TIMER,
					sctimer_readCounter(),
					TIME_MS,
					opendtls_handshake_cb
				);

				openserial_printInfo( COMPONENT_OPENDTLS, ERR_CERT_VERIFY, opendtls_vars.ssl.state, OPENDTLS_CERT_VERIFY_TIMER );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_CLIENT_CHANGE_CIPHER_SPEC:
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_CLIENT_CHANGE_CIPHER_SPEC, opendtls_vars.ssl.state, OPENDTLS_CLIENT_CHANGE_CIPHER_SPEC );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_CLIENT_FINISHED:
				...
				opentimers_scheduleAbsolute(
					opendtls_vars.timerId,
					OPENDTLS_CLIENT_FINISHED,
					sctimer_readCounter(),
					TIME_MS,
					opendtls_handshake_cb
				);

				openserial_printInfo( COMPONENT_OPENDTLS, ERR_CLIENT_DONE, opendtls_vars.ssl.state, OPENDTLS_CLIENT_FINISHED );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break; 
			...
			case MBEDTLS_SSL_SERVER_CHANGE_CIPHER_SPEC:
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_SERVER_CHANGE_CIPHER_SPEC, opendtls_vars.ssl.state, OPENDTLS_SERVER_CHANGE_CIPHER_SPEC );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break; 
			...
			case MBEDTLS_SSL_SERVER_FINISHED:
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_SERVER_DONE, opendtls_vars.ssl.state, OPENDTLS_SERVER_FINISHED );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break; 
			...
			case MBEDTLS_SSL_FLUSH_BUFFERS:
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_FLUSH_BUFFERS, opendtls_vars.ssl.state, OPENDTLS_FLUSH_BUFFERS );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
			...
			case MBEDTLS_SSL_HANDSHAKE_WRAPUP:
				...
				openserial_printInfo( COMPONENT_OPENDTLS, ERR_HANDSHAKE_WRAPUP, opendtls_vars.ssl.state, OPENDTLS_HANDSHAKE_WRAPUP );
				scheduler_push_task( handshake_task , TASKPRIO_TLS );
				break;
