...
enum {
   ...
   ERR_FRAG_REASSEMBLY_TIMEOUT         = 0x1d, // reassembly timer expired for fragments with tag {0}
   ERR_FRAG_VRB_TIMEOUT                = 0x1e, // vrb timer expired for fragments with tag {0}
   ...
   ERR_SYNCHRONIZED                    = 0x31, // synchronized at slotOffset {0}
   ...
   ERR_NO_FREE_TIMER                   = 0x48, // no free timer (code location {0})
